...
public class AppCompilador extends JFrame implements ActionListener{
	...
	private JButton Abrir, Analizar;
	...
	private void creaInterFaz() {
		...
		menuCompilar = new JMenu("Compilador");
		...
		itemCompilar = new JMenuItem("Compilar");
		...
		documentos.addTab("Programa", new JScrollPane(areaTexto));
